...
def create_url(id="your-user-id", tweet_fields="tweet.fields=lang,author_id,id"):
...
def get_user_liked_tweets_by_user_id(user_id,):
    url, tweet_fields = create_url(user_id)
    json_response = connect_to_endpoint(url, tweet_fields)
